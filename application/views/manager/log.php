...
<div class="card shadow-box fw-bold">
    <div class="card-header bg-primary text-light">
      FILTER :
        ...
        min :
          <input class="btn btn-sm btn-light mt-1" type="date" name="" id="mindate" value="" max="" min="" onchange="filter()" >
        max :
          <input class="btn btn-sm btn-light mt-1" type="date" name="" id="maxdate" value="" max="" min="" onchange="filter()">
          <div class="float-end">
          <a href="<?= site_url('manager/log/cetak/true/true/true') ?>" id="pdf" class="btn btn-sm btn-light mt-1" target="_blank">CETAK PDF</a>
          <a href="<?= site_url('manager/log/export/true/true/true') ?>" id="excel" class="btn btn-sm btn-light mt-1">CETAK XLSX</a>
          <a class="btn btn-sm btn-light mt-1" href="<?= site_url('manager/log/print/true/true/true') ?>" id="print" target="_blank">PRINT</a>
        </div>
    </div>
    <div class="card-body">
