        ...
        <table id="example" class="table table-striped">
          ...
          <tbody>
            ...
            <tr>
                ...
                <td><div class="mx-1 mb-1 btn btn-success" data-bs-toggle="modal" data-bs-target="#detail'.$r->kode_transaksi.'">Detail</div><div class="mx-1 mb-1 btn btn-primary">Cetak</div></td>
            </tr>'
             :
             ''
             ?>
