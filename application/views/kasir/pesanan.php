<div class="row" style="height:100%">
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button onclick="f_confirm()" type="submit" id="btn-submit" class="btn btn-primary disabled">BAYAR</button>
                </div>
                </form>
            </div>
        </div>
    ...
    <div class="modal fade modal-after" id="modal-after" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-after">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <div class="card rounded-1 shadow-box mx-auto px-2" style="width: 400px; font-size: 14px">
                        ...
                        <table class="table table-striped" style="font-size:12px">
                            ...
                            <tbody>
                                <?php foreach($this->cart->contents() as $cc): ?>
                                    <tr>
    ...
    <div class="modal" id="iframe" tabindex="-1">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="card mx-auto" style="width: fit-content">
                        <iframe id="iframe-content" src="<?= base_url('kasir/akun') ?>" frameborder="1" style="width:400px" onload="resizeIframe(this)"></iframe>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">TUTUP</button>
                    <a href="" id="btn-cetak" type="button" target="_blank" class="btn btn-primary">CETAK</a>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    window.onload = () => {
        const k1 = document.getElementById('iframe')
        const k2 = document.getElementById('iframe-content')
        const k3 = document.getElementById('btn-cetak')
        if(sessionStorage.length > 0){
            k2.src = "riwayat/struk/"+sessionStorage.id;
            k3.href = "riwayat/cetak/"+sessionStorage.id;
            $('#iframe'). modal('show');
    ...
    function f_a(){
        confirm('Pastikan Sudah Terjadi Pembayaran');
    }
    
    function f_b(){
        sessionStorage.setItem("id", "<?= $this->PesananModel->id() ?>");
    }
</script>