...
<html lang="en">
  ...
  <body>
    ...
    <table class="styled-table" style="display:  <?= $dashboard ?>">
      ...
      <tbody>
        <tr>
          <td style="font-size: 20px; text-align:center">RP <?= number_format($get_pendapatan_harian) ?></td>
          <td style="font-size: 20px; text-align:center"><?= $get_produk_terjual_harian ?></td>
          <td style="font-size: 20px; text-align:center"><?= $get_total_transaksi_harian ?></td>
          <td style="font-size: 20px; text-align:center"><?= $get_produk_terlaris_harian ?></td>
        </tr>
      </tbody>
    </table>
    <table class="styled-table" >
      ...
      <tbody>
        <?php $i=1; foreach($get_harian as $a): ?>
          <tr>
            <td><?= $i++ ?></td>
